...
@Controller
@RequestMapping(value="/person") // view 앞에 /person 이 붙여짐
public class PersonController {
	
	@RequestMapping(value="/listPerson.do", method=RequestMethod.GET) // /person/listPerson.do 가 붙여짐
	...
	public String getPerson(Model model) { // model: view에 보여줄 데이터

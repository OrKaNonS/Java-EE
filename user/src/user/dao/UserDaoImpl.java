...
public class UserDaoImpl implements UserDao {
	...
	public int insertUser(User user) {
		...
		int result = jdbcTemplate.update(sql, user.getUserId(), user.getName(), user.getGender(), user.getCity());
		return result;
	}
	...
	public List<User> getUserList() {
		...
		return jdbcTemplate.query(sql, new RowMapper<User>() {
			...
			public User mapRow(ResultSet rs, int rowNum) throws SQLException {
				...
				user.setName(rs.getString("userNo"));
	...
	public int updateUser(User user) {
		...
		int result = jdbcTemplate.update(sql, user.getUserId(), user.getName(), user.getGender(), user.getCity(), user.getUserNo());
		return result;
	}
